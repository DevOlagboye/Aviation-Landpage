...
const HeroPage = () => {
  ...
  const handleExpand = () => {
    gsap.to(bookButton, { y: 10, duration: 0.8, ease: Power3.easeOut });
    setExpand(true);
  };
  const handleShrink = () => {
    gsap.to(bookButton, { y: 0, duration: 0.8, ease: Power3.easeIn });
    setExpand(false);
  };
  useEffect(() => {
    gsap.to(".hero-image", { y: 25, duration: 5, opacity: 1 });
    gsap.fromTo(
      [logoItem, heroPageText, heroPageTextP],
      {
        opacity: 0,
        y: 20,
      },
    ...
    <div>
      <div className="hero-container">
        ...
        <div className="hero-page-text">
          ...
          >
            Aviation Travel around the world One of the advantages of being
